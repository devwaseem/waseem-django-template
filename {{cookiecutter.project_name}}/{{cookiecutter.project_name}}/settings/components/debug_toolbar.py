...
from {{cookiecutter.project_name}}.settings.components.common import INSTALLED_APPS, MIDDLEWARE
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    if DEBUG
    else "{{cookiecutter.project_name}}.settings.debug_toolbar.django_debug_toolbar_show_only_for_admins" # noqa
}
