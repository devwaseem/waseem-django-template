...
from env import Env
from {{cookiecutter.project_name}}.settings.vars import BASE_DIR, DEBUG
...
PROJECT_APPS: list[str] = [
    "{{cookiecutter.project_name}}.apps.Config",
]
...
MIDDLEWARE: list[str] = [
    # Logging:
    # "{{cookiecutter.project_name}}.middleware.disable_client_side_caching_middleware", # Uncomment this line to disable client side caching # noqa
    # "django.middleware.cache.UpdateCacheMiddleware",  # This must be first on the list # noqa
    # "{{cookiecutter.project_name}}.settings.components.logging.LoggingContextVarsMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Custom
                "{{cookiecutter.project_name}}.context_processors.get_site_data",
            ],
        },
    },
]
