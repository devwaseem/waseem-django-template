...
from {{cookiecutter.project_name}}.settings.vars import DEBUG, ENABLE_SILK_PROFILING, ENABLE_HEALTH_CHECK
from {{cookiecutter.project_name}}.views.home import HomeView
