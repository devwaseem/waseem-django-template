...
from src.settings.vars import BASE_DIR, DEBUG
...
MIDDLEWARE: list[str] = [
    # Logging:
    # "src.middleware.disable_client_side_caching_middleware", # Uncomment this line to disable client side caching # noqa
    # "django.middleware.cache.UpdateCacheMiddleware",  # This must be first on the list # noqa
    # "src.settings.components.logging.LoggingContextVarsMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Custom
                "src.context_processors.get_site_data",
            ],
        },
    },
]
